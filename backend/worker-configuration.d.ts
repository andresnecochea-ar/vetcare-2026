/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=backend/wrangler.jsonc backend/worker-configuration.d.ts` (hash: a5d57a886c32a03320c8b26f412d0887)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	APP_VERSION: "2.4.0";
	ALLOWED_ORIGINS: "https://andresnecochea-ar.github.io,null";
	INVITE_CODE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "ALLOWED_ORIGINS" | "INVITE_CODE">> {}
}
